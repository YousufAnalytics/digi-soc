    ...
    <section className="relative bg-[#fcfcfd]">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col justify-center px-6 pb-14  lg:min-h-[75vh]">
        ...
        <div className="mt-10 flex flex-wrap items-center gap-5">
          {/* Primary CTA */}
          <button className="group flex items-center gap-2 rounded-2xl bg-gradient-to-r from-indigo-600 to-violet-500 px-7 py-4 text-sm font-semibold text-white shadow-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-xl">
